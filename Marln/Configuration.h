...
#define DELTA_EFFECTOR_OFFSET 25.9 // mm

// Horizontal offset of the universal joints on the carriages. Edit to change curvature. Raise value raises center.
#define DELTA_CARRIAGE_OFFSET 5.0 // mm
...
#define MANUAL_Z_HOME_POS 137  // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {87, 87, 87, 18}
#define DEFAULT_MAX_FEEDRATE          {200, 200, 200, 200}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {9000,9000,9000,5}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
